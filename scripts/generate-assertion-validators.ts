...
assertPlaytestAssertionRegistryComplete();
const generatedSchemas = PLAYTEST_ASSERTION_REGISTRY.map(compactEntry);
...
export function renderGeneratedAssertionValidators(): string {
