...
import { k as IPlaytestProtocolDiagnostic, m as IPlaytestScenario, j as IPlaytestPointer, l as IPlaytestReport, g as IPlaytestObservations, f as IPlaytestFramebufferCoverageObservation, b as IPlaytestCaptureProvenance, d as IPlaytestDiagnosticsPolicy, a as IPlaytestAssertionResult, c as IPlaytestDiagnostic, I as IPlaytestArtifactRequest } from '../diagnostics-CnH0EfqA.js';
...
declare const WEBGPU_BROWSER_ARGS: readonly ["--ozone-platform=x11", "--enable-unsafe-webgpu", "--disable-gpu-sandbox", "--ignore-gpu-blocklist", "--enable-features=Vulkan"];
declare function resolveBrowserArguments(browserArgs: readonly string[] | undefined): string[];
/**
 ...
 */
declare function softwareAdapterName(adapter: Readonly<Record<string, string>> | undefined): string | undefined;
interface IBrowserPointerChange {
    isPrimary: boolean;
    pointer: Required<IPlaytestPointer>;
    type: "pointerdown" | "pointermove" | "pointerup";
}
declare function reconcileBrowserPointers(previous: ReadonlyMap<number, Required<IPlaytestPointer>>, next: readonly IPlaytestPointer[]): IBrowserPointerChange[];
...
declare const PLAYTEST_FLAGS: {
    ...
    readonly "--allow-software": {
        readonly default: "false";
        readonly summary: "accept a software WebGPU adapter as evidence";
 ...
 */
declare function writeObservationArtifacts(artifactDirectory: string, requested: IPlaytestArtifactRequest | undefined, observations: {
    console: readonly unknown[];
    network: readonly unknown[];
    runtimeTrace: {
        readonly recentRuntimeErrors?: readonly unknown[];
 ...
 */
declare function isRuntimeReadout(entry: unknown): boolean;
/**
...
export { ANDROID_TRANSPORT_CAPABILITIES, AdbAndroidDriver, DeviceBridgeTransport, DeviceMailboxTransport, type IAndroidDriver, type IAndroidDriverOptions, type IAndroidPlaytestDependencies, type IAndroidPointer, type IAndroidPointerInjection, type IBridgeTransport, type IBrowserPointerChange, type IDeviceMailbox, type IDeviceMailboxPaths, type IDevicePlaytestDriver, type IDevicePlaytestTarget, type IDevicePlaytestTransport, type IIosCommandOptions, type IIosDriverOptions, type IIosPlaytestDependencies, type IPlaytestBridgeClient, type IPlaytestFlagHelp, type IPlaytestServerConfig, type IRunIosCommand, type IStandalonePlaytestConfig, type IStandalonePlaytestReport, type IosTransportKind, PLAYTEST_FLAGS, PlaytestBridgeError, PlaytestCliUsageError, PlaywrightTransport, STANDALONE_PLAYTEST_OBSERVATION_FIELDS, WEBGPU_BROWSER_ARGS, XcrunIosDriver, androidMailboxPaths, androidTouchBatches, boundedTeardownStep, buildReport, captureVisualSurface, connectPlaytestBridge, connectPlaytestBridgeTransport, deviceMailboxPaths, discoverAdb, failedDiagnosticsAssertion, formatUsage, initStandalonePlaytest, isRuntimeReadout, openPageAndConnectBridge, pageLifecycleDiagnostic, parseAndroidConsole, parseLaunchedPid, parseStandalonePlaytestArgs, playtestStepDrivesMovement, preflightDisplay, reconcileBrowserPointers, recordToScenario, requireAssertions, resolveBrowserArguments, rotatedTouchPosition, runAndroidPlaytest, runDevicePlaytest, runIosPlaytest, runStandalonePlaytest, softwareAdapterName, validateDeviceEndpoint, writeCaptureProvenance, writeObservationArtifacts };
