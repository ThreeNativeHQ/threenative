...
import { h as IPlaytestProtocolDiagnostic, j as IPlaytestScenario, i as IPlaytestReport, d as IPlaytestObservations, c as IPlaytestFramebufferCoverageObservation, a as IPlaytestDiagnostic } from '../diagnostics-D_s5XC8t.js';
...
declare function buildReport(config: IStandalonePlaytestConfig, scenario: IPlaytestScenario, beforeSnapshot: IPlaytestObservationSnapshot | undefined, afterSnapshot: IPlaytestObservationSnapshot | undefined, consoleEntries: Array<{
    ...
    after?: unknown;
    before?: unknown;
}>, runtimeReady?: boolean, visual?: IPlaytestObservations["visual"], labeledSamples?: readonly ILabeledPlaytestSample[], framebufferCoverage?: IPlaytestFramebufferCoverageObservation | undefined): IStandalonePlaytestReport;
