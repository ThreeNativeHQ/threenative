...
export { Area3D as A, rapier as B, CharacterBody3D as C, type NavigationAgent3DOptions as D, type NavigationAgentEvent as E, type NavigationAgentHandler as F, type NavigationContext as G, NavigationObstacle3D as H, type NavigationObstacle3DOptions as I, type NavigationPlugin as J, NavigationRegion3D as K, type NavigationRegion3DOptions as L, recast as M, NavigationAgent3D as N, PHYSICS_COLLISION_EVENT_STRIDE as P, RigidBody3D as R, type Area3DOptions as a, type AreaContact as b, type AreaEvent as c, type AreaHandler as d, type CharacterBody3DOptions as e, CollisionShape3D as f, type CollisionShapeHandle as g, type CollisionShapeKind as h, PHYSICS_TRANSFORM_STRIDE as i, type PhysicsBody3D as j, type PhysicsBodyCreateOptions as k, type PhysicsBodyHandle as l, type PhysicsCharacterOptions as m, type PhysicsColliderHandle as n, type PhysicsContext as o, type PhysicsHandle as p, type PhysicsInputSnapshot as q, type PhysicsOptions as r, type PhysicsPlugin as s, type PhysicsRuntimeSimulation as t, type PhysicsShapeDescriptor as u, type PhysicsShapeKind as v, type PhysicsSimulation as w, type PhysicsWorldHandle as x, type RigidBody3DOptions as y, type RigidBodyType as z };
