export { f as IPlaytestAdvanceResult, g as IPlaytestAnimationObservation, e as IPlaytestBridgeDescription, h as IPlaytestBridgeHost, i as IPlaytestBridgeReady, b as IPlaytestBridgeV1, j as IPlaytestContactObservation, k as IPlaytestEntityObservation, l as IPlaytestEntityTransform, c as IPlaytestGameplayObservation, I as IPlaytestObservationSnapshot, a as IPlaytestSampleRequest, d as IPlaytestSetupRequest, m as IPlaytestTagObservation, n as JsonPrimitive, J as JsonValue, o as PLAYTEST_BRIDGE_GLOBAL, p as PLAYTEST_PROTOCOL_LIMITS, q as PLAYTEST_PROTOCOL_VERSION, P as PlaytestClockMode, r as assertJsonSafe, s as jsonByteLength } from './protocol-BrSrLHZX.js';

type PlaytestCapability = "browser.canvas" | "browser.console" | "browser.dom" | "browser.input" | "browser.network" | "browser.screenshot" | "browser.trace" | "camera.observe" | "entity.bounds" | "entity.observe" | "entity.setup" | "runtime.animation" | "runtime.components" | "runtime.contacts" | "runtime.diagnostics" | "runtime.events" | "runtime.fixedStep" | "runtime.physics" | "runtime.resources" | "runtime.state" | "runtime.tags" | "runtime.ui" | "runtime.world";
...
type PlaytestDiagnosticCode = "TN_PLAYTEST_BRIDGE_INCOMPATIBLE" | "TN_PLAYTEST_BRIDGE_MISSING" | "TN_PLAYTEST_BRIDGE_NOT_READY" | "TN_PLAYTEST_CAPABILITY_MISSING" | "TN_PLAYTEST_OPERATION_TIMEOUT" | "TN_PLAYTEST_PAYLOAD_TOO_LARGE" | "TN_PLAYTEST_SERVER_FAILED";
...
export { type IPlaytestAerodynamicsAssertion, type IPlaytestAnimationAssertion, type IPlaytestArtifactRequest, type IPlaytestAssertionResult, type IPlaytestAssertionSchemaEntry, type IPlaytestAssertionSchemaField, type IPlaytestCameraAssertion, type IPlaytestCapabilityDescriptor, type IPlaytestComponentAssertion, type IPlaytestContactAssertion, type IPlaytestDiagnostic, type IPlaytestDiagnosticsAssertion, type IPlaytestFollowReport, type IPlaytestMovementAssertion, type IPlaytestObservations, type IPlaytestOccludedAssertion, type IPlaytestOverlayNodeAssertion, type IPlaytestParityConfig, type IPlaytestPathAssertion, type IPlaytestProtocolDiagnostic, type IPlaytestReachabilityAssertion, type IPlaytestReport, type IPlaytestScenario, type IPlaytestScenarioAssertions, type IPlaytestScenarioDiagnostic, type IPlaytestScenarioSetup, type IPlaytestSettledAssertion, type IPlaytestSetupEntityTransform, type IPlaytestSetupResource, type IPlaytestSetupSchemaEntry, type IPlaytestStateAssertion, type IPlaytestStep, type IPlaytestTagCountAssertion, type IPlaytestTransformSample, type IPlaytestViewport, type IPlaytestVisibilityAssertion, type IPlaytestVisualAssertion, type IPlaytestWorldAssertion, PLAYTEST_ASSERTION_REGISTRY, PLAYTEST_CAPABILITY_REGISTRY, PLAYTEST_SETUP_REGISTRY, type PlaytestCapability, type PlaytestDiagnosticCode, type PlaytestInputDelivery, PlaytestScenarioError, type PlaytestTarget, type PlaytestVec3, applyScenarioOverrides, evaluateRichPlaytestAssertions, loadPlaytestScenario, missingPlaytestCapabilities, oneShotScenario, overlayNodeObservationKey, parsePlaytestTarget, parseViewport, playtestDiagnostic, playtestStepHoldTicks, playtestStepWaitTicks, requiredPlaytestCapabilities, unknownPlaytestCapabilities };
