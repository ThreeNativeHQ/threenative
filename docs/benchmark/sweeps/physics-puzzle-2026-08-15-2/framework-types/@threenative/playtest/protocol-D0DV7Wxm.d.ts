...
interface IPlaytestPerformanceObservation {
    drawCalls?: number;
    triangles?: number;
}
...
interface IPlaytestRuntimeDiagnosticsSample {
    drawCalls?: number;
    frameMs: number;
    triangles?: number;
}
...
export { type IPlaytestBridgeDescription as I, type JsonValue as J, PLAYTEST_BRIDGE_GLOBAL as P, type IPlaytestBridgeV1 as a, type IPlaytestContactObservation as b, type IPlaytestDeviceRequest as c, type IPlaytestDeviceResponse as d, type IPlaytestGameplayObservation as e, type IPlaytestObservationSnapshot as f, type IPlaytestPerformanceObservation as g, type IPlaytestRuntimeDiagnosticsSample as h, type IPlaytestSampleRequest as i, type IPlaytestSetupRequest as j, type IPlaytestWorldObservation as k, type IPlaytestWorldRuntimeObservation as l, PLAYTEST_PROTOCOL_LIMITS as m, PLAYTEST_PROTOCOL_VERSION as n, assertJsonSafe as o, jsonByteLength as p };
