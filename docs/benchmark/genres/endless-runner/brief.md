# Endless runner sweep brief

Build a small, playable 3D endless runner from the supplied `reference.png`.

- Use a forward-facing camera that makes the next obstacle and the player immediately readable.
- Move the player continuously and support lane changes plus a jump or slide.
