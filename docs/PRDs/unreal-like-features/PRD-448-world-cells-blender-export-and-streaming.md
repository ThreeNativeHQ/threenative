...
**Status:** IN PROGRESS: contract, validator and sampler are done; the committed fixture comes from the Phase 2 recipe
**ACs:** AC-1, AC-3
**Files:**
...
- [ ] fixture committed (generated, CC0 primitives only)
...
- [ ] recipe
- [ ] MCP tool registered and invoked in the spec
- [ ] fixture package regenerated by the recipe (proves AC-1's fixture is recipe output)
