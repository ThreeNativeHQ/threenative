...
| [`requires-hosted-run/`](requires-hosted-run/) | [PRD-059](requires-hosted-run/PRD-059-native-dependency-provenance-sbom.md) | A current hosted run satisfying PRD-059 provenance/SBOM evidence; the release execution work moved to production-readiness |
...
PRD-060, PRD-078 and PRD-221 moved to [production-readiness](../production-readiness/README.md) on 2026-09-08 under owner instruction. Their old blocker observations are retained as history; current execution prerequisites must be rechecked.
