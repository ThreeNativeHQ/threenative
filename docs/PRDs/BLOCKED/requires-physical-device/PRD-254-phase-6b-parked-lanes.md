# PRD-254 Phase 6B — two parked lanes remain

**Status:** BLOCKED
**Filed:** 2026-08-28 by the PRD-254 landing
**Missing evidence:** a physical Pixel 8 for two remaining lanes.

PRD-254 Phase 6B said these lanes must be landed or filed, and that "still sitting in a
worktree" is not an acceptable end state. Two remain live and need device evidence. Five other
rows are retained below as adjudication history: one unsafe change was rejected and four stale
...
mobile-decoder, host-gap, frame-budget and crash-handler rows above are historical adjudications and
are no longer blocked work; two live rows remain.
