...
[PRD-267](../../useful-defaults/PRD-267-screen-space-gi-ships-in-the-templates.md). Deciding the rejection
...
[PRD-270](../../useful-defaults/PRD-270-no-lighting-node-ships-web-only.md).
