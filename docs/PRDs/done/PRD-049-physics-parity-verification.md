...
| 5 | `docs/verification/PRD-049.md` | gate `packages/physics/__tests__/documentation.spec.ts:14-22`; index `docs/architecture/NATIVE-RUNTIME.md` (was `docs/PRDs/native/README.md:24-27`, deleted 2026-08-22) | nothing | n/a | deleting or unlinking the report fails the root Vitest gate |
