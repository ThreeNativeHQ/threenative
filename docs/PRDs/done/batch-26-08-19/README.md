...
| 5 — a toolchain-free user ships from published artifacts | Ten release tags, zero surviving releases; needs a hosted run | **no** — [PRD-078](../PRD-078-toolchain-free-consumer-proof.md), stays blocked |
...
| 5 | Untouched by design | Untouched. [PRD-078](../PRD-078-toolchain-free-consumer-proof.md) still needs a hosted run |
