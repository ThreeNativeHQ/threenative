...
Engine platform mechanism. All styles/layout/React stay in the game. Reuse the original PRD-217 bridge and native UI opt-out; no CEF/Electron or renderer replacement. [PRD-365](../production-readiness/critical/PRD-365-consumer-desktop-distribution.md) owns distribution of required platform components; [PRD-153](PRD-153-game-branding-from-launch-to-play.md) owns visible branding; [PRD-366](../production-readiness/critical/PRD-366-one-consumer-game-proves-supported-platforms.md) owns candidate game qualification.
...
- [x] PRD-262/365/366 consume these exact implementations; no native-ready claim comes from core-only screenshots.
      [PRD-365](../production-readiness/critical/PRD-365-consumer-desktop-distribution.md) and [PRD-366](../production-readiness/critical/PRD-366-one-consumer-game-proves-supported-platforms.md) name this PRD as the HUD/overlay supplier in their ledgers, and [PRD-262](PRD-262-the-runtime-native-prebuilt-release-exists.md) supplies the prebuilt host these lanes build against. Every native-ready claim here is backed by a real HUD attach/input observation (hosted or local) or a named prerequisite, never a core-only screenshot; the consumer PRDs own their own end-to-end verification.
