...
PRD-230.** Filed from
the runtime-native refactor analysis (`docs/audits/`, since removed)
...
| [232](./PRD-232-profiling-is-a-component-not-a-smear.md) | `TN_ANDROID_JS_PROFILE`'s 64 sites and the frame-phase counters become one `FrameProfiler`, with byte-identical output | 5 → MEDIUM | 230 phase 2; **coordinate with [227](../../performance/PRD-227-the-frame-crosses-once.md) and [228](../PRD-228-the-pixel-budget-is-the-engines.md)** |
...
| [234](../PRD-234-the-scripts-tier-has-one-device-library.md) | Rejected and reverted: the shared device layer added 404 census lines, firing its kill switch | 4 → MEDIUM | none |
