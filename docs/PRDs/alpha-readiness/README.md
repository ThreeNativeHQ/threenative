...
|---|---|---|---|
| A1 | A stranger can install it from the public registry | **red** | `npm view <package> versions --json` — 3 of 7 publishable package(s) are absent from the registry: @threenative/runtime-native, @threenative/studio, create-threenative. Unpublished workspace version(s): @threenative/core 0.2.0, @threenative/physics 0.2.0, @threenative/playtest 0.2.0, @threenative/ui 0.2.0. |
