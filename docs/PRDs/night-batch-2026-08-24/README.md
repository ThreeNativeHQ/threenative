...
2. **The primary checkout had a live lane at filing time** — uncommitted device-metrics +
...
| C — physical Pixel 8 | `192.168.1.192:5555` | Finish [PRD-217](../PRD-217-webview-ui-layer.md) criterion 3 + Phase 3B, then [PRD-214 Phase 0](../batch-2026-08-23-mobile-stability/PRD-214-render-js-owns-the-mobile-frame.md) | 217 died at 39.8 °C / 13 % battery mid-capture — overnight is the thermal reset. Then the 19 FPS ceiling bisect, sequenced last by its own batch because the lanes above were needed first |
...
- Charter-performance batch (189–195) and the remaining tech-debt structural passes
  (202, 203–208): next batch, after tonight's merges.
