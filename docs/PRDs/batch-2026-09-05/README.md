...
| --- | --- | --- | --- |
| 1 | [360 — Android launch](../BLOCKED/requires-physical-device/PRD-360-android-launch-is-playable-within-eight-seconds.md) | Playable within 8 seconds, instead of the recorded 15–35-second startup. **BLOCKED** on `requires-physical-device` since 2026-09-07: engine work and CI proof delivered, three physical cold launches outstanding | PRD-339 / PRD-327 |
...
Next action (under 2 minutes): open PRD-361 and read phase 1. PRD-360 has moved to
`docs/PRDs/BLOCKED/requires-physical-device/` and needs a phone, not a next action here.
