...
4. **A PRD with non-hardware work left normally stays in the parent folder.** If the manager
   reaches the two-review cap, it may move here only with the named defects and a concrete
   specification-reopen resume path recorded in the execution ledger.
...
## Why 058, 059 and 060 are not here
