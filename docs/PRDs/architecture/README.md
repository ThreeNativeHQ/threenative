...
| 2 — confirm `gpuMs` reports on Android | [PRD-305](../BLOCKED/requires-physical-device/PRD-305-the-gpu-meter-reports-on-android.md) — **BLOCKED**, no device attached ([probe](../../verification/gpu-meter-android-probe-2026-09-01.md)) | 1 |
