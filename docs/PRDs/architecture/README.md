...
| 3 — CI deletes every baked file and proves the game is identical | ✅ [PRD-306](../done/PRD-306-the-delete-test-is-a-gate.md) — **done**, green and in CI ([record](../../verification/delete-test-passes-2026-09-01.md)) | 1 |
