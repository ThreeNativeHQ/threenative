...
| 4 — bake prefiltered reflections into `@threenative/assets` | ✅ [PRD-307](../done/PRD-307-reflections-are-prefiltered-before-the-game-ships.md) — **refuted**, the set-once environment result was unresolvable: its −0.37 ms inversion is only a lower-bound/noise observation, no independent positive resolution was recorded, and forced per-frame prefiltering cost +1.61 ms ([record](../../verification/environment-cost-attribution-2026-09-01.md)) | 2 |
