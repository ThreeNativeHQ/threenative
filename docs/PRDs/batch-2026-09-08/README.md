...
| Separate | [196 — Complete public installation](../production-readiness/critical/PRD-196-published-install-is-functional.md) | The installation/release lane remains independently owned. | Preserve its existing acceptance and release handoffs; it is outside this performance execution. |
