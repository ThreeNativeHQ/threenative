...
| 2 | [368 — Compiled pipelines survive a relaunch](../assets/PRD-368-compiled-pipelines-survive-a-relaunch.md) | Owner-suggested priority; attacks the measured 8,513 ms of pipeline creation on compatible relaunches. | First prove the selected native C API and binary can create, serialize and reuse a real pipeline. Only then implement persistence. |
