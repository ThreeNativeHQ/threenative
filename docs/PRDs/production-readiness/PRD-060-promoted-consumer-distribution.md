...
```text
threejs-webgpu/
├── AGENTS.md                                                        # AUTHORITY: release honesty/default gates
├── package.json                                                     # EXISTING CALLER: workspace build/parity surface
├── artifacts/                                                       # GENERATED/IGNORED: runtime/parity evidence
├── .github/workflows/
│   ├── ci.yml                                                       # READ/DEPENDENCY: exact-candidate CI
│   ├── native-platforms.yml                                         # READ/DEPENDENCY: PRD-054 target evidence
│   └── native-release.yml                                           # EDIT P1-P5: gate, sign, publish, consume, finalize/cleanup
├── scripts/
│   ├── release-candidate-gate.ts                                    # NEW P1, EDIT P5: schema, preflight, promotion/revocation audit
│   └── __tests__/release-candidate-gate.spec.ts                     # NEW P1, EDIT P5: state/evidence controls
├── docs/
│   ├── architecture/CHARTER.md                                      # AUTHORITY: platform/release claim limits
│   ├── PRDs/
│   │   ├── PRD-053-core-input-multitouch.md                      # OWNER/DEPENDENCY: multitouch
│   │   ├── PRD-054-write-once-run-anywhere.md                    # OWNER/DEPENDENCY: parity
│   │   ├── PRD-055-native-hud-reopened.md                        # OWNER/ANTI-SCOPE: HUD/text
│   │   ├── native/
│   │   │   ├── PRD-046-physics-native.md                         # OWNER/DEPENDENCY: physics
│   │   │   ├── PRD-048-native-distribution.md                    # OWNER/DEPENDENCY: local mechanics
│   │   │   └── README.md                                        # EDIT P6: support/release truth
│   │   ├── production-readiness/
│   │   │   ├── PRD-056-physical-mobile-qualification.md          # OWNER/DEPENDENCY: physical devices
│   │   │   ├── PRD-059-native-dependency-provenance-sbom.md       # OWNER/DEPENDENCY: provenance/SBOM
│   │   │   └── PRD-060-promoted-consumer-distribution.md          # DELETE P6: moved only at DONE
│   │   └── done/
│   │       └── PRD-060-promoted-consumer-distribution.md          # NEW P6: moved planning artifact
│   └── verification/
│       ├── PRD-048.md                                               # READ/DEPENDENCY: local distribution evidence
│       ├── PRD-059.md                                               # GENERATED BY OWNER/DEPENDENCY: provenance evidence
│       ├── PRD-060.md                                               # NEW P6: exact release evidence
│       └── prd-054-android-color-2026-08-09.md                       # READ/DEPENDENCY: current parity blocker
├── packages/
│   ├── create-threenative/
│   │   ├── package.json                                             # READ/PUBLISHED SUBJECT: CLI version
│   │   ├── src/build.ts                                            # EDIT P2-P3: release-mode dispatch
│   │   ├── __tests__/
│   │   │   ├── build.spec.ts                                      # EDIT P2: desktop release controls
│   │   │   └── publication.spec.ts                                # EDIT P4: cohort/template registry contract
│   │   └── templates/
│   │       ├── minimal/package.json                                  # EDIT P4: exact promoted cohort pins
│   │       ├── starter/package.json                                  # EDIT P4: exact promoted cohort pins
│   │       └── platformer/package.json                               # EDIT P4: exact promoted cohort pins
│   └── runtime-native/
│       ├── AGENTS.md                                                  # AUTHORITY: platform/build limits
│       ├── package.json                                               # READ/PUBLISHED SUBJECT: runtime version/install hook
│       ├── third_party/                                               # GENERATED/UNTRACKED: native dependencies
│       ├── scripts/
│       │   ├── install-prebuilt.mjs                                  # EDIT P5: lock identity/N-1 contract
│       │   ├── package-desktop.mjs                                  # EDIT P2: signed/notarized release output
│       │   ├── package-android.mjs                                  # EDIT P3: signed APK/AAB release output
│       │   └── package-ios.mjs                                      # EDIT P3: signed archive/exported IPA
│       └── tests/
│           ├── distribution.test.mjs                                 # EDIT P3/P5: mobile/lock/compatibility controls
│           └── native-platform-workflow.test.mjs                     # EDIT P1-P5: release wiring/ordering gate
├── release/                                                            # GENERATED/UNTRACKED: staged signed assets, locks, SBOM, provenance
│   ├── release-candidate.json                                       # GENERATED: releaseCandidateV1
│   ├── release-evidence.json                                        # GENERATED: releaseEvidenceV1
│   └── release-revocation.json                                      # GENERATED ONLY ON REVOCATION
└── .runtime/prd060/                                                   # GENERATED/IGNORED: controls, consumer locks/logs/media
```
