...
| [PRD-217](../done/PRD-217-webview-ui-layer.md) | Default React HUD on Windows/macOS/Linux sessions | DONE — phases 1/2/3A/3B green on hosted Windows/macOS (run 34739248955), phase 4 Linux X11 input 8/8 with the Wayland input prerequisite named; owner-delegated review 2026-09-12 | None for platform implementation |
...
| [PRD-376](../done/PRD-376-windows-consumer-builds-and-runs.md) | A Windows consumer installs the published runtime, builds and runs | DONE — phases and acceptance verified, reviewer PASS; moved to done/ | — |
