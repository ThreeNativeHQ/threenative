...
**Charter authority:** `AGENTS.md` "Never claim a platform you did not execute";
`CHARTER.md` §7 (device matrix) and §10a. `docs/PRDs/native/blocked/README.md` owns what
...
- **An fps *gate*.** The iOS simulator runs Metal on a virtualized host. A frame rate measured
  ...
  be `CHARTER.md` §7 exactly backwards. Phase 3 captures frame *timing* as a labelled
