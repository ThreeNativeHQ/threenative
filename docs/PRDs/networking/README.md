...
| PRD | Status | Outcome |
| --- | --- | --- |
| [PRD-359 — portable multiplayer transport](./PRD-359-portable-multiplayer-transport.md) | IN PROGRESS — Tasks 0/1a/1a-close/2b-streams/2b-send passed; transport queue bounds next | Players on browser, Windows, macOS, Linux, Android and iOS share a server using the same game source |
...
Follow [EXECUTION.md](./EXECUTION.md); Task 2b-signal is next. Native stream strategy/lifecycle proof passed on Linux V8 and QuickJS. The reviewed Task 2a native slice is implemented; full queue-bound acceptance remains open through Task 2b.
