...
**Execution in progress, 2026-09-05.** Tasks 0, 1a and 1a-close passed. Tasks 2a, 2b-streams, 2b-send, 2b-signal, 2b and 2b-proof passed; the live queue/reconnect checkpoint is accepted. Task 2c DNS passed; Task 1b-trust is next. Execute this file in table order.
