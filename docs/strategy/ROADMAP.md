...
| Save/load and deterministic replay | [PRD-036](../PRDs/PRD-036-save-load-and-deterministic-replay.md) | **partial implementation merged; checked-in replay consumer passes on isolated Brave/WebGPU; full browser/manual release evidence pending** |
