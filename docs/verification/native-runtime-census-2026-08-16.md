...
| `conformance/` | 8,644 | PRD-053, PRD-054, PRD-055, PRD-076 | `conformance/run-conformance.mjs`; root `pnpm parity` | Replace cross-target registry/proofs with untested per-game scripts | **KEEP** — shared executable conformance evidence. |
...
| **Total** | **116,716** |  | `pnpm budgets` current measurement |  | **No area rejected.** |
