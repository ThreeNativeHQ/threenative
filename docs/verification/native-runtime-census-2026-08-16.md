...
| **Total** | **78,246** |  | `pnpm budgets` current measurement |  | **No area rejected.** |
...
The native review trigger remains visible at 78,246 / 50,000. Physical Android, iOS, and hardware
