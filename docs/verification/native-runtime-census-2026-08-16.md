...
| Root `CMakeLists.txt` | 2,466 | PRD-047, PRD-048, PRD-050 | `pnpm native:build`; explicit binding target build | Make every game own native dependency discovery and linking | **KEEP** — opt-in host build configuration. |
...
| **Total** | **137,931** |  | `pnpm budgets` current measurement |  | **No area rejected.** |
