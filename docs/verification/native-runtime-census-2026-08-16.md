...
| `package.json` | 95 | PRD-048, PRD-050, PRD-054, PRD-116 | `native:build`, `native:physics:parity`, and `native:verify:desktop` scripts | Hide opt-in native commands in per-game manifests | **KEEP** — package-level command contract. |
...
| **Total** | **153,321** |  | `pnpm budgets` current measurement |  | **No area rejected.** |
