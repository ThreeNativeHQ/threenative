...
| `tests/` | 9,466 | PRD-045, PRD-046, PRD-048, PRD-049, PRD-050, PRD-053, PRD-054, PRD-055, PRD-076, PRD-116, PRD-127, PRD-143, PRD-153, PRD-154, PRD-155 | `tests/physics_actuation_bindings_test.cpp:141`; runtime-native Vitest and native tests | Delete fail-closed tests to reduce the trigger | **KEEP** — removal would conceal regressions. |
...
| **Total** | **78,261** |  | `pnpm budgets` current measurement |  | **No area rejected.** |
...
The native review trigger remains visible at 78,261 / 50,000. Physical Android, iOS, and hardware
...
| --- | --- | --- |
| `pnpm budgets` | PASS, exit `0` | 6 framework packages, 7 example workspaces, 13,869/15,000 framework LOC, 78,261/50,000 native runtime LOC, 12 PRD files, largest template 2,246 LOC; the native review trigger remains visible. |
