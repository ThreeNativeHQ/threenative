...
| `conformance/` | 6,677 | PRD-053, PRD-054, PRD-055, PRD-076 | `conformance/run-conformance.mjs`; root `pnpm parity` | Replace cross-target registry/proofs with untested per-game scripts | **KEEP** — shared executable conformance evidence. |
...
| **Total** | **107,309** |  | `pnpm budgets` current measurement |  | **No area rejected.** |
