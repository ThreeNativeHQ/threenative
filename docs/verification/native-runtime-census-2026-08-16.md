...
| `tests/` | 8,228 | PRD-045, PRD-046, PRD-048, PRD-049, PRD-050, PRD-053, PRD-054, PRD-055, PRD-076, PRD-116, PRD-127 | `tests/physics_actuation_bindings_test.cpp:141`; runtime-native Vitest and native tests | Delete fail-closed tests to reduce the trigger | **KEEP** — removal would conceal regressions. |
...
| **Total** | **72,857** |  | `pnpm budgets` current measurement |  | **No area rejected.** |
...
| --- | --- | --- |
| `pnpm budgets` | PASS, exit `0` | 7 framework packages, 5 example workspaces, 15,293/15,000 framework LOC, 72,857/50,000 native runtime LOC, 12 PRD files, largest template 1,997 LOC; both review triggers remain visible. |
