// The neutral replay wire protocol, owned by core. Moved verbatim out of the playtest
// harness (PRD-181): harnesses depend on engines, never the reverse, and a parser duplicated
// on both sides could skew between them. Error codes are pinned by specs in both packages -
// do not reword.
