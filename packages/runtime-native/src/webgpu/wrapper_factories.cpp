...
js::JSValueHandle createTextureWrapper(
    ...
    state->engine->setProperty(
        jsTexture,
        "createView",
        state->engine->newFunction(
            "createView",
            [state, textureId](void*, const std::vector<js::JSValueHandle>&) {
...
js::JSValueHandle createPipelineWrapper(
    ...
    state->engine->setProperty(
        ...
        state->engine->newFunction(
            "getBindGroupLayout",
            [state, pipelineId, renderPipeline](void*, const std::vector<js::JSValueHandle>& args) {
