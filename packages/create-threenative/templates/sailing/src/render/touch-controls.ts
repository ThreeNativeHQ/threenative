...
function movementPoint(size: ITouchViewport): Vector2 {
...
export class TouchControls {
  ...
  #input: ITouchInput = { move: new Vector2() };
  ...
  dispose(): void {
    ...
    this.#resting.copy(movementPoint(size));
  }
