...
const desktopPreset = {
  ...
  exposure,
  ssgiEnabled: true,
  // Room scale, not contact scale: about two thirds of the 45-unit shadow extent
  // `lighting.ts` lights — a long track: the gather radius is wide because the scene is, and the road is the one surface worth reflecting.
  ssgiRadius: 30,
  ssgiQuality: "medium",
  ssrEnabled: true,
