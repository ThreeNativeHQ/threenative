...
const desktopPreset = {
  ...
  exposure,
  ssgiEnabled: true,
  // Room scale, not contact scale: about two thirds of the 20-unit shadow extent
  // `lighting.ts` lights — an interior arena, which is the case screen-space GI is best at.
  ssgiRadius: 14,
  ssgiQuality: "medium",
  ssrEnabled: true,
