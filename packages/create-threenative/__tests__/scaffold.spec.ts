...
const PRD_201_PARENT_SCAFFOLD_HASHES: Readonly<Record<string, string>> = {
  ...
  // Recomputed 2026-08-30 for the PRD-276 manager-gate continuation: the committed fixture was
  // stale against baseline 4a73a5f, so these are the seven hashes measured in this corrected lane.
};
