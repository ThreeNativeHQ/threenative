...
// A fresh MCP server loads its complete module graph before answering initialize. Keep ordinary
// discovery calls fast, but allow this cold-start handshake to survive a busy CI shard.
