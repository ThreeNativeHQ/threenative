...
const EDITOR_OBJECT_VERSION_GUID_BYTES = Uint8Array.from([
  0xed, 0x68, 0xb0, 0xe4, // E4B068ED
  0xe9, 0x42, 0x94, 0xf4, // F49442E9
  0x0b, 0xda, 0x31, 0xa2, // A231DA0B
  0x41, 0xbb, 0x46, 0x2e, // 2E46BB41
]);
...
export function readPackageSummary(bytes: Uint8Array): IPackageSummary {
  ...
  if (packageTag !== PACKAGE_FILE_TAG) {
    throw new UAssetError("INVALID_PACKAGE_TAG", "Input is not a legacy Unreal package (.uasset/.umap)", {
